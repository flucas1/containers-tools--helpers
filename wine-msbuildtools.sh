...
if [ "${DIRECTINSTALL}" = "yes" ] ; then
  ...
  timeout 900s wget --no-verbose --retry-connrefused --waitretry=3 --tries=20 "https://aka.ms/vs/${VISUALSTUDIOVERSION}/release/vs_BuildTools.exe" -O ./msbuildtools-installer.exe
